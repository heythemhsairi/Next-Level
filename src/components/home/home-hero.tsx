...
export function HomeHero({
  ...
  return (
    <section className="reveal relative overflow-hidden rounded-[26px] border border-white/10 bg-gradient-to-br from-brand via-brand-dark to-[#170406] p-5 shadow-brand-glow sm:p-6 surface-grain">
      <div className="pointer-events-none absolute -right-16 -top-20 h-44 w-44 rounded-full bg-brand-light/25 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-24 -left-10 h-40 w-40 rounded-full bg-brand/30 blur-3xl" />
      ...
      <div className="relative">
        ...
        <div className="mt-2 flex flex-wrap items-center gap-3">
          <h1 className="text-2xl font-display font-extrabold tracking-tight text-white md:text-[28px]">
